        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 md:gap-12 mb-12">
          ...
          <div>
            ...
            <div className="text-muted-foreground text-sm font-body font-light space-y-2">
              <p>
                Tel:{" "}
                <a href="tel:530978968" className="text-primary hover:text-gold-light transition-colors">
                  530 978 968
                </a>
              </p>
              <p>
                Tel:{" "}
                <a href="tel:669513740" className="text-primary hover:text-gold-light transition-colors">
                  669 513 740
                </a>
              </p>
              <p>
                Email:{" "}
                <a href="mailto:glabcio@interia.pl" className="text-primary hover:text-gold-light transition-colors">
                  glabcio@interia.pl
                </a>
              </p>
              <p className="pt-3">
